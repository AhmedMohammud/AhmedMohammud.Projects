...
public class Piece {
    ...
    public void promote(int row, int col, boolean isBlack) {
        switch (this.character) {
            case '\u2659':
                if (row == 7) {
                    Scanner promotionPiece = new Scanner(System.in);
                    String promotion;
                    System.out.println("Please choose your promotion rank for your pawn: Knight, Bishop, Rook, or Queen.");
                    promotion = promotionPiece.nextLine();
                    if (promotion.equals("Knight")) {
                        ...
                        this.setCharacter('\u2656');
                    } else if (promotion.equals("Queen")) {
                        this.setCharacter('\u2655');
                    } else {
                        System.out.println("That is not an option! Please choose again : Knight, Bishop, Rook, Queen");
                    }
                }
